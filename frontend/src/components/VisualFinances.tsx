    ...
    return(
        <div id = "visual">
            ...
            <h5 className="self-start ml-[10%] text-lg text-left">Is The Expense Recurring?</h5>
                ...
                <button id = "ExpenseAdd" className = "rounded-sm inline-block absolute top-[80%] left-[40%] h-fit w-fit p-[10px] pt-[5px] pb-[7px] bg-transparent border border-[#6d91e8] text-center text-[1.8vh]" onClick = {addExpense}>Add Expense</button>
        </div>
    );
}
