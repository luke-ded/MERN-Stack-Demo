...
const Results: React.FC<ChildProps> = ({ triggerRerender }) =>
{
    ...
    function displayDModal(item: Item) {
        ...
        <>
            ...
            <div>
                ...
                <button className = "fixed left-[38%] top-[80%] rounded-sm inline-block h-fit w-fit p-[10px] pt-[5px] pb-[7px] bg-transparent border border-[#6d91e8] text-center text-[1.8vh] hover:bg-blue-400/15 hover:border-[#bdc8e2]" onClick = {() => {deleteIncome(item, event)}}> Confirm</button>
        ...
        <>
            ...
            <div>
                ...
                <br></br>
                    ...
                    <button id = "EditIncome" className = "fixed left-[29%] top-[84%] rounded-sm inline-block h-fit w-fit p-[10px] pt-[5px] pb-[7px] bg-transparent border border-[#6d91e8] text-center text-[1.8vh] hover:bg-blue-400/15 hover:border-[#bdc8e2]" onClick ={() => {if(isButtonClicked){editIncome(item, date, isRecurring, event)}}}>Edit Income</button>
    ...
    function refreshIncomeList() {
        ...
        var data = localStorage.getItem('user_data');
        var parsedData = data ? JSON.parse(data) : null;
        console.log("After deletion the income array length is " + parsedData.User.Income.length);
        if (!root) {
            root = ReactDOM.createRoot(container);
        }
        ...
        if (parsedData.User.Income.length == 0){
            root.unmount();
        }
