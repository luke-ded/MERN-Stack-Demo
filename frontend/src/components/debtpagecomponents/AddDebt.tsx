    ...
    return(
        <div id = "visual">
            ...
            <div className="flex-col">
                ...
                <input className="h-7 w-8/10 text-lg rounded-sm border border-[#6d91e8] bg-blue-400/5 focus:outline-none focus:ring-1 focus:ring-[#7f8fb5] p-1" type="text" placeholder = "1.23" id = "apr"onKeyUp={(e) => {
                    if (e.key === "Enter") 
                    {
                ...
                <input className="h-7 w-8/10 text-lg rounded-sm border border-[#6d91e8] bg-blue-400/5 focus:outline-none focus:ring-1 focus:ring-[#7f8fb5] p-1" type="text" placeholder = "12" id = "term"></input>
